...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{<code>{file_name}</code> <b>ᴊᴏɪɴ [@TamilRockerz_FZN](https://t.me/TamilRockerz_FZN) ꜰᴏʀ ᴍᴏʀᴇ ᴍᴏᴠɪᴇꜱ</b> <b>Pᴏᴡᴇʀᴇᴅ Bʏ @TamilRockerz_FZN</b>}")
